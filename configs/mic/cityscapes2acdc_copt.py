...
_base_ = [
    ...
    # Cityscapes->ACDC High-Resolution Data Loading
...
uda = dict(
    ...
    # Covariance-based Pixel-Text Loss
    copt=True,
    # EMA Memory bank for CoPT Loss
    membank=True,
    # Task to specify domain attributes
    task = 'cs2acdc')
...
name = 'cs2acdc_mic_copt'
exp = 'basic'
use_wandb = False
pname_dataset = 'cityscapesHR2acdcHR_1024x1024'
